            ...
            foreach ($page in $section.Page) {
                "#### " + $page.name
                    ...
                    try {
                        ...
                        #pandoc -t markdown --lua-filter C:\Users\Nick\Downloads\OneNoteMDPersonal\ConvertOneNote2MarkDown-master\plaintext2.lua your-document.docx
                        #pandoc.exe -f docx -t markdown -L C:\Users\Nick\Downloads\OneNoteMDPersonal\ConvertOneNote2MarkDown-master\plaintext2.lua -i $fullexportpath -o "$($fullexportpathwithoutextension).md" --wrap=none --atx-headers --extract-media="$($fullexportdirpath)"
                        #pandoc.exe -f docx -t markdown -L C:\Users\Nick\Downloads\OneNoteMDPersonal\ConvertOneNote2MarkDown-master\plaintext2.lua -i $fullexportpath -o "$($fullexportpathwithoutextension).md" --wrap=none --atx-headers --extract-media="$($fullexportdirpath)"
                        #pandoc.exe -f docx -t markdown --filter C:\Users\Nick\Downloads\OneNoteMDPersonal\ConvertOneNote2MarkDown-master\plaintext.hs -i $fullexportpath -o "$($fullexportpathwithoutextension).md" --wrap=none --atx-headers --extract-media="$($fullexportdirpath)"
                        #pandoc.exe -t markdown --lua-filter=C:\Users\Nick\Downloads\OneNoteMDPersonal\ConvertOneNote2MarkDown-master\plaintext.lua your-document.docx -i $fullexportpath -o "$($fullexportpathwithoutextension).md" --wrap=none --atx-headers --extract-media="$($fullexportdirpath)"
                    }
                    catch {
